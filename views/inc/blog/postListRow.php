...
<tr>
	<td class='listName'><a href='<? echo URL."blog/post/$url"; ?>'><? echo $title; ?></a></td>
	<td><? echo $date; ?></td>
	<td><a class='btn btn-default btn-sm togglePublic' href='#' id='<? echo $contentID; ?>'><? echo $publishLink; ?></a></td>
	<td>
		<a class='btn btn-primary btn-sm' href='<? echo URL."blog/post/$url"; ?>'>View</a>
		<a class='btn btn-primary btn-sm' href='<? echo URL."blog/editpost/$url"; ?>'>Edit</a>
